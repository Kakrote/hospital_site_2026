    ...
    return (
        <section className="py-16 md:py-28 bg-linear-to-br from-slate-50 to-blue-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-8 mx-auto items-start">
                    <div>

                        {/* Header */}
                        <div className="mb-10 md:mb-16 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
                                ...
                                >
                                    ...
                                    >
                                        <button
                                            ...
                                            className="w-full px-4 sm:px-6 md:px-8 py-4 md:py-5 flex items-center justify-between gap-4 text-left group/btn"
                                        >
                                            <div className="flex items-start sm:items-center gap-3 sm:gap-4 flex-1 min-w-0">
                                                ...
                                                <h3 className={`font-semibold transition-colors duration-300 leading-snug wrap-break-word ${openIndex === index
                                                    ? 'text-[#1566a8] text-base sm:text-lg'
                                            ...
                                            <ChevronDown
                                                className={`w-5 h-5 text-[#1566a8] transition-transform duration-300 shrink-0 ml-2 ${openIndex === index ? 'rotate-180' : ''
                                                    }`}
                                            />
                                        </button>

                                        {openIndex === index && (
                                            <div className="px-4 sm:px-6 md:px-8 pb-5 border-t border-slate-100 animate-in fade-in slide-in-from-top-2 duration-300">
                                                <p className="text-slate-700 leading-7 md:leading-8 text-sm sm:text-base md:text-lg">
                                                    {faq.answer}
                                                </p>
                                            </div>
                                        )}
                    ...
                    {/* CTA Section */}
                    <div className="h-full flex justify-center items-stretch lg:items-center">

                        <div className="mt-6 lg:mt-16 w-full max-w-xl p-6 sm:p-8 md:p-10 rounded-2xl bg-linear-to-r from-[#1566a8] to-[#1566a8]/80 text-white text-center h-fit">
