  ...
  return (
    <section className='bg-gradient-to-r from-[#0e1d4e] via-[#2f4155] to-[#18479e] py-20 text-[#d6d61d]'>
      <div className='container mx-auto text-center text-3xl  py-4 '>
        <h1 className='container mx-auto text-white font-bold font-figtree'>About </h1>
        <h2 className='text-3xl md:text-4xl  font-figtree font-semibold text-transparent text-stroke'>Uttaranchal Hospital & Diagnostic Centre</h2>
      </div>
